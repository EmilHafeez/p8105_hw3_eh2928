...
The most commonly observed snowfall values is 0 (since most days in
these locations, it doesn’t snow\!). Then, unfortunately, there are a
...
mean\_tmax = mean(tmax, na.rm = TRUE)
