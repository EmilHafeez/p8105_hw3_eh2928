...
accel_df =
  ...
  mutate(
   weekend = case_when(
            day_of_week == c("Saturday" | "Sunday") ~ "Weekend",
            day_of_week == c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday") ~ "Weekday"),
     weekend = recode(weekend, weekday = c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday"))
  )
